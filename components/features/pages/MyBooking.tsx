...
const MyBooking = () => {
  ...
  return (
    <div className="py-28 md:pb-36 md:pt-32 px-4 md:px-24 xl:px-32">
      <h1 className="font-bold text-4xl md:text-[40px]">My Bookings</h1>
      <p
        className="text-sm md:text-base text-gray-500/90 mt-2
            max-w-174"
      >
        Take advantage of our limited-time offers and special package to enhance
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex flex-col gap-1.5 max-md:mt-3 md:ml-4">
                ...
                <div className="flex items-center gap-1 text-sm text-gray-500">
                  <Image src={assets.locationIcon} alt="location-img" />
                  <span>{booking.hotel.address}</span>
                </div>
                <div className="flex items-center gap-1 text-sm text-gray-500">
                  <Image src={assets.guestsIcon} alt="guests-icon" />
